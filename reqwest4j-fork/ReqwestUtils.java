...
public class ReqwestUtils {
    ...
    // Fork addition: per-request egress proxy override. proxy="" (or null) =
    // direct egress; a proxy URL routes this single request through it. Lets the
    // backend pick the currently-unflagged IP family per request without re-init.
    public static native CompletableFuture<Response> fetchWithProxy(String url, String method, byte[] body,
